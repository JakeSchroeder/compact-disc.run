        ...
        <div className="text-white relative space-y-40 w-full h-full flex flex-col justify-center items-center">
          <div className="flex flex-col items-center space-y-6 text-xl">
            <blockquote className="text-center leading-loose max-w-prose">
              “Humans on planet earth used to enjoy walking up to their desks. Sitting down for prolonged periods of
              time. Surfacing the so-called inter-webs. However, around the mid 2000s the enjoyment turned to stress and
