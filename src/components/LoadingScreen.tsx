//Current not in use rn, because want to show in index.html
    ...
    <div className="text-white relative space-y-40 w-full h-full flex flex-col justify-center items-center">
      <div className="flex flex-col items-center space-y-6 text-xl">
        <blockquote className="text-center leading-loose max-w-prose">
          “Humans on planet earth used to enjoy walking up to their desks. Sitting down for prolonged periods of time.
          Surfacing the so-called inter-webs. However, around the mid 2000s the enjoyment turned to stress and fatigue.
          Historians chalk it up to many tangentially related things.”
        </blockquote>
        <div className="h-px w-8 bg-white bg-opacity-30"></div>
        <div className="text-white text-opacity-70">- Tired Magazine (2024)</div>
      </div>
      <div className="w-full text-xs max-w-lg space-y-3">
        <div className="flex justify-between items-center">
          <div className="text-white text-opacity-70">Loading...</div>
          <div className="text-white text-opacity-35">/path/to/path/to/that-one-really-cool-asset.zip</div>
        </div>
