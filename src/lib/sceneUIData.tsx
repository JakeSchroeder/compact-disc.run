...
export const allScenesList: TScene[] = [
...

  {
    ...
    hudProps: {
      type: "PlayerHUD",
      dialogueText: "Objective: Look for the leather-bound book of secrets.\n It rests by the plastic apple.",
  ...
  },
  {
    ...
    hudProps: {
      ...
      nextClue: "Find the framed keepsake of love and kin, often where dreams begin.", //Need to update this in backend
    },
    cameraProps: {
      type: "PLAYER",
    },
  ...
  },
  {
    ...
    hudProps: {
      type: "PlayerHUD",
      dialogueText: "Objective: Find the framed keepsake of love and kin, often where dreams begin.",
  ...
  },
  {
    ...
    hudProps: {
      ...
      nextClue: "Find the tales of the cunning raccoon in this PS2 game, where stealthy adventures begin.",
    },
    cameraProps: {
      type: "PLAYER",
    },
  ...
  },
  {
    ...
    hudProps: {
      ...
      nextClue: "Find the wooden ride made famous by Tony, rolling where tricks begin.",
    },
    cameraProps: {
      type: "PLAYER",
    },
...

  {
    ...
    hudProps: {
      type: "PlayerHUD",
      dialogueText: "Objective: Find the wooden ride made famous by Tony, rolling where tricks begin.",
  ...
  },
  {
    ...
    hudProps: {
      ...
      nextClue: "Find the steel tools of precision, often kept where defense begins.",
    },
    cameraProps: {
      type: "PLAYER",
    },
...

  {
    ...
    hudProps: {
      type: "PlayerHUD",
      dialogueText: "Objective: Find the steel tools of precision, often kept where defense begins.",
  ...
  },
  {
    ...
    hudProps: {
      ...
      nextClue: "Find the martial art of grappling, practiced where strength and technique begin.",
    },
    cameraProps: {
      type: "PLAYER",
    },
  },
  {
    ...
    hudProps: {
      type: "PlayerHUD",
      dialogueText: "Objective: Find the martial art of grappling, practiced where strength and technique begin.",
  ...
  },
  {
    ...
    hudProps: {
      ...
      nextClue: "Find the digital realm of blocks and creativity, where endless adventures begin.",
    },
    cameraProps: {
      type: "PLAYER",
    },
...

  {
    ...
    hudProps: {
      type: "PlayerHUD",
      dialogueText: "Objective: Find the digital realm of blocks and creativity, where endless adventures begin.",
  ...
  },
  {
    ...
    hudProps: {
      ...
      nextClue: "Find the symbol of virtual conquests, celebrating victories where epic quests begin.",
    },
    cameraProps: {
      type: "PLAYER",
    },
...

  {
    ...
    hudProps: {
      type: "PlayerHUD",
      dialogueText: "Objective: Find the symbol of virtual conquests, celebrating victories where epic quests begin.",
  ...
  },
  {
    ...
    hudProps: {
      ...
      year: "2013",
      place: "Tyria",
      description: "The 3rd game that really inspired me. I only played PVP for Glory.",
      clue: "Find the symbol of virtual conquests, celebrating victories where epic quests begin.",
      nextClue: "Find the recognition of coding excellence, honoring achievements where innovation begins.",
    },
    cameraProps: {
      type: "PLAYER",
    },
  ...
  },
  {
    ...
    hudProps: {
      ...
      nextClue: "Find the collection of paranormal cases, uncovering mysteries where the truth begins.",
    },
    cameraProps: {
      type: "PLAYER",
    },
...

  {
    ...
    hudProps: {
      type: "PlayerHUD",
      dialogueText: "Objective: Find the collection of paranormal cases, uncovering mysteries where the truth begins.",
  ...
  },
  {
    ...
    hudProps: {
      ...
      nextClue: "Find the melodies and harmonies, resonating where emotions and rhythm begin.",
    },
    cameraProps: {
      type: "PLAYER",
    },
  },
  {
    ...
    hudProps: {
      type: "PlayerHUD",
      dialogueText: "Objective: Find the melodies and harmonies, resonating where emotions and rhythm begin.",
  ...
  },
  {
    ...
    hudProps: {
      ...
      nextClue: "Find the expressions on canvas, depicting beauty and thought where creativity begins.",
    },
    cameraProps: {
      type: "PLAYER",
    },
...

  {
    ...
    hudProps: {
      type: "PlayerHUD",
      dialogueText: "Objective: Find the expressions on canvas, depicting beauty and thought where creativity begins.",
  ...
  },
  {
    ...
    hudProps: {
      ...
      nextClue: "Find the place of higher learning, reflecting the journey where knowledge and paths begin.",
    },
    cameraProps: {
      type: "PLAYER",
    },
  ...
  },
  {
    ...
    hudProps: {
      ...
      nextClue: "Find the foundation of design and innovation, rooted in basics where understanding begins.",
    },
    cameraProps: {
      type: "PLAYER",
    },
  ...
  },
  {
    ...
    hudProps: {
      ...
      nextClue: "Now that you have collected all the artifacts, decrypt the message from the PC.",
    },
    cameraProps: {
      type: "PLAYER",
    },
...

  {
    ...
    hudProps: {
      type: "PlayerHUD",
      dialogueText: "Objective: Now that you have collected all the artifacts, decrypt the message from the PC.",
      dialogueHoverText: "Press F to interact [PC]",
    },
    cameraProps: {
      type: "PLAYER",
